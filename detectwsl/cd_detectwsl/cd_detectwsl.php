...
##
## Exemple repris et modifié par Yoann LECLERC pour le plugin detectwsl
...
$list_fields = array(
                    ...
                    'Utilisateur contenant des distributions' => 'USER',
...
$sql['SQL']  .= "FROM $form_name WHERE (hardware_id = $systemid)";
